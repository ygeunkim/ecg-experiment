...
```{r takecoffee, echo=FALSE, fig.cap="Taking Coffee"}
knitr::include_graphics("../docs/images/taking-coffee.png")
```
...
```{r measuringecg, echo=FALSE, fig.cap="Measuring ECG"}
knitr::include_graphics("../docs/images/measure-ecg.png")
```
...
- **Outliers**
    ...
    - Table \@ref(tab:diffdata): value of `14`

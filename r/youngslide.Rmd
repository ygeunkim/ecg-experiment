...
\begin{enumerate}[A]
  \item House blend (74.5 mg) to \texttt{1}
  \item Water (0 mg) to \texttt{4}
  \item Sumatra (54.5 mg) to \texttt{2}
  \item Decaf espresso roast (3 mg) to \texttt{3}
\end{enumerate}
...
- Variability: The first treatment (`HB`) seem too variable
...
- Other samples: Correct arbitrarily set levels
    - Re-define the levels of each factor
- Re-measure (for Unit `8` and `11`)

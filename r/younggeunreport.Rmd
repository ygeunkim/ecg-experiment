...
```{r, include=FALSE}
fig_subcap <- c(
  "(1,1),House blend", "(1,2),Water", "(1,3),Sumatra"
)
fig_subcap <- str_c(fig_subcap, str_c(ecg$bpm[1:3], " BPM"), sep = ": ")
```


```{r resplot, echo=FALSE, fig.cap="ECG Results", fig.subcap = fig_subcap, fig.asp=1, fig.ncol = 3, out.width="30%"}
# (1, 1)----------------------------------------------------
